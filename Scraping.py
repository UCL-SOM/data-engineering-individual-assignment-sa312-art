...
# Set the rules to scrape and filter 50 tweets that mention vaccines/vaccination/transperancy/efficiacy
...
# Set the rules to scrape and filter 50 tweets about the EU Medicines Agency and WHO organization
